...
static class STMCustomInspectorTools {
	public static void DrawTitleBar(UnityEngine.Object myObject, SuperTextMesh stm){
		...
		//delete button:
			...
			{
				Undo.RecordObject(stm, "Deleted Data");
				...
				*/
				...
				//if(mat.GetInt("_Effect") == 0)
				{
					...
					if(sdfMode)
					{
						...
						if(mat.HasProperty("_EffectBlend"))
						{
							//EditorGUILayout.PropertyField(shaderEffectBlend);
							mat.SetFloat("_EffectBlend", EditorGUILayout.Slider("Effect Blend", mat.GetFloat("_EffectBlend"), 0.0001f, 1f));
						}
