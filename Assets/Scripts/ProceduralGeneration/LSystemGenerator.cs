...
public class LSystemGenerator : MonoBehaviour
{
    ...
    [Range(0, 1)] public float chanceToIgnoreRule = 0.3f; // chance to not create branch where it normally would
    ...
    private string GrowRecursive(string word, int iterationIndex = 0)
    {
        ...
        foreach(var character in word)
        {
            ...
            ProcessRulesRecursively(newWord, character, iterationIndex);
        }
        return newWord.ToString();
    }

	private void ProcessRulesRecursively(StringBuilder newWord, char character, int iterationIndex)
	{
